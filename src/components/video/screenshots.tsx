import { screenshotAlt, screenshotCaption, type ScreenshotSeoContext } from "@/lib/seo/screenshots";
          ...
          <li key={src}>
            <figure className="m-0 flex flex-col gap-1">
              <div className="bg-surface relative aspect-video w-full overflow-hidden rounded-lg">
                ...
                <img
                  src={src}
                  alt={screenshotAlt(seo, n)}
                  title={screenshotCaption(seo, n)}
                  width={640}
                  height={360}
                  loading="lazy"
                  decoding="async"
              ...
              <figcaption className="text-muted truncate text-xs">
                {screenshotCaption(seo, n)}
              </figcaption>
            </figure>
          </li>
        );
